...
class SystemHook(object):
    ...
    def __init__(self, hook_id, on_hook=lambda code, msg, lpdata: None, convert_func=None):
    ...
    def _handler(code, msg, lpdata):
        ...
        if self:
            ...
            try:
                result = self.on_hook(code, msg, lpdata)
...
class ListenerMixin(object):
    ...
    def _run(self):
        ...
        with self._receive():
            ...
            # pylint: disable=W0702; we want to silence errors
            try:
                with SystemHook(self._EVENTS, self._handler, self._convert):
                    # Just pump messages
    ...
    def _handler(self, code, msg, lpdata):
        ...
        try:
            ...
            result = action.status_manager.press_update()
            if converted is not None and result == 1 and converted[0] == 256:
